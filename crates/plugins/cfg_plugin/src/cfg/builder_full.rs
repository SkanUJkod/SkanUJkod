...
impl ControlFlowGraph {
    pub fn build(fset: &FileSet, func: &FuncDecl, objs: &AstObjects) -> Self {
        ...
        // Note: optimization and validation calls commented out for now since we don't have those modules yet
        // crate::cfg::optimization::clean_unreachable_blocks(&mut blocks, entry);
        // crate::cfg::optimization::optimize_empty_blocks(&mut blocks, entry, exit_id, &label_def_ids);
        // crate::cfg::optimization::clean_unreachable_blocks(&mut blocks, entry);
